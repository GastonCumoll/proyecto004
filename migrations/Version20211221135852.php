 ...
 */
final class Version20211221135852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publicacion (id INT AUTO_INCREMENT NOT NULL, usuario_creador_id INT NOT NULL, tipo_publicacion_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, fecha_yhora DATETIME NOT NULL, INDEX IDX_62F2085F91C4469F (usuario_creador_id), INDEX IDX_62F2085F16187A47 (tipo_publicacion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
