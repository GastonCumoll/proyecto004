 ...
 */
final class Version20211216140402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publicacion (id INT AUTO_INCREMENT NOT NULL, usuario_creador_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, tipo_publicacion VARCHAR(255) NOT NULL, fecha_yhora DATE NOT NULL, INDEX IDX_62F2085F91C4469F (usuario_creador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
